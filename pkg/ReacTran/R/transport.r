...
# check input
gn <- names(grid)
if (! "x.mid"  %in% gn) stop("error in setup.2Dprop: grid should be a list that contains x.mid")
if (! "x.int"  %in% gn) stop("error in setup.2Dprop: grid should be a list that contains x.int")
